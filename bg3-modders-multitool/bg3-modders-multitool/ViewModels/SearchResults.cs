    ...
    public class SearchResults : BaseViewModel
    {
        ...
        public bool RenderModel()
        {
            ...
            if (FileHelper.IsGR2(SelectedPath))
            {
                ...
                Task.Run(() => {
                    var mesh = RenderedModelHelper.GetMesh(Path.ChangeExtension(FileHelper.GetPath(SelectedPath), null), new System.Collections.Generic.Dictionary<string, string>()); // TODO get materials
